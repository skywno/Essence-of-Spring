...
public class JdkDynamicProxyTests {
	...
	void useDynamicProxy() throws Exception {
		...
		InvocationHandler handler = new PerformanceInvoationHandler(movieReader);
	...
	static class PerformanceInvoationHandler implements InvocationHandler {
		
		final Logger log = LoggerFactory.getLogger(getClass());
		final Object target;
		
		public PerformanceInvoationHandler(Object target) {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			log.info("Excecution {} method finsiehd in {} ms", method.getName(), elapsed);
